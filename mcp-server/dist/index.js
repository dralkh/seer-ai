...
import { getZoteroClient } from "./zoteroClient.js";
...
class SeerAIMcpServer {
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (!isHealthy) {
                throw new McpError(ErrorCode.InternalError, "Zotero is not running or the Seer-AI plugin is not installed. Please start Zotero first.");
            }
